...
public class MergeTest {
    private <T extends Comparable<T>>void check(List<T> first, List<T> second){
    ...
    public void specialMergeTest2(){
        check(new ArrayList<>(List.of(17, 20, 30, 30, 54, 54, 65, 65, 65, 70, 76, 77, 88, 89, 105, 120, 120, 124, 126, 133, 149, 153, 155, 163, 164, 178, 187, 189, 191, 191)), new ArrayList<>(List.of(11, 12, 13, 20, 22, 31, 31, 36, 37, 45, 51, 54, 57, 66, 68, 69, 83, 102, 104, 107, 123, 147, 151, 158, 162, 171, 173, 175, 179, 197)));
    }
    @Test
    public void specialMergeTest3(){
        check(new ArrayList<>(List.of(3, 12, 20, 21, 25, 29, 39, 42, 68, 71, 74, 85, 88, 89, 95, 101, 112, 131, 135, 140, 142, 157, 162, 163, 165, 177, 182, 186, 194, 199)), new ArrayList<>(List.of(2, 4, 8, 13, 17, 18, 38, 47, 54, 55, 57, 59, 64, 76, 82, 82, 85, 90, 91, 99, 104, 110, 111, 144, 159, 163, 164, 175, 194, 197)));
    }
    @Test
